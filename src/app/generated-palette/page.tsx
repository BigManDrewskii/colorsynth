        ...
        <Card className="w-full bg-[#1B1B1B] border-[#3C3C3C] shadow-lg transition-all duration-300 ease-in-out">
          <CardContent className="p-6 flex flex-col items-center gap-6">
            ...
            <div className="flex flex-wrap justify-between w-full gap-4">
              <Button 
                className="bg-[#6366F1] hover:bg-[#6366F1]/90 text-white transition-all duration-300 ease-in-out z-20" 
          ...
          <CardContent className="p-6 flex flex-col items-center gap-6">
            ...
            <div className="w-full">
              <Select value={harmony} onValueChange={(value: ColorHarmony) => setHarmony(value)}>
                <SelectTrigger className="w-full bg-[#252525] text-[#F2F7F2] border border-[#4E4E4E] rounded-md p-2 transition-all duration-300 ease-in-out cursor-pointer">
                  <SelectValue placeholder="Select harmony" />
                </SelectTrigger>
                <SelectContent className="bg-[#252525] border-[#4E4E4E]">
                  <SelectItem value="analogous" className="cursor-pointer">Analogous</SelectItem>
                  <SelectItem value="complementary" className="cursor-pointer">Complementary</SelectItem>
                  <SelectItem value="triadic" className="cursor-pointer">Triadic</SelectItem>
                  <SelectItem value="tetradic" className="cursor-pointer">Tetradic</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
